...
bt_admin_help = InlineKeyboardButton('Помощь', callback_data='admin_help')

kb_admin_menu = InlineKeyboardMarkup().add(bt_admin_create_give, bt_admin_created_gives).add(bt_admin_started_gives).add(bt_admin_executed_gives).add(bt_admin_active_chat).add(bt_admin_help)
